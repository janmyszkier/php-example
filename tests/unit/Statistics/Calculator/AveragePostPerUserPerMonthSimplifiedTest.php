 ...
 * @package Tests\unit
 */
class AveragePostPerUserPerMonthSimplifiedTest extends TestCase
{
    ...
    public function __construct(?string $name = null, array $data = [], $dataName = '')
    {
        ...
        $this->params = [
            (new ParamsTo())->setStatName(StatsEnum::AVERAGE_POST_NUMBER_PER_USER_PER_MONTH_SIMPLIFIED)
        ];
    }
    ...
    {
        $this->assertEquals(1, $statValues['2022-02']);
    }
    ...
    {
        $this->assertEquals(2, $statValues['2022-02']);
        $this->assertEquals(3, $statValues['2022-01']);
    }
    ...
    {
        $this->assertEquals(0.5, $statValues['2021-01']);
        $this->assertEquals(1, $statValues['2021-02']);
        $this->assertEquals(1.5, $statValues['2021-03']);
    }
    ...
    private function getTwoUserPosts(): \Traversable
    {
        ...
        yield (new SocialPostTo)->setAuthorId(self::USER_1_ID)->setAuthorName(self::USER_1_NAME)->setDate(new \DateTime('2021-03-01'));
        yield (new SocialPostTo)->setAuthorId(self::USER_1_ID)->setAuthorName(self::USER_1_NAME)->setDate(new \DateTime('2021-03-01'));
    }
